...
def executeProgram(programArr, inputArr):
    ...
    while programCounter < len(programArr):
        ...
        if cmd == "assign":
            ...
            variableList[ops[0]] = ops[1] # Need to save to memory? 
            pass
        ...
        if cmd == "-":
            ...
            variableList[ops[0]] = max(variableList[ops[1]] - variableList[ops[2]], 0) # Take max because cannot handle negative values
            pass
        if cmd == "*":
            # ['*', i, j, k]: compute (var_j * var_k) and store in var_i.
        ...
        if cmd == "goto":
            ...
            if variableList[ops[0]] == 0: 
                # GOTO line j, using programCounter
                programCounter = ops[1] - 1 # Because will add one at the end of this line 
            pass
